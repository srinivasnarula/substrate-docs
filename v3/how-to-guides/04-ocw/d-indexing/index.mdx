...
> Notes
>
> In order to see the off-chain indexing feature in action, run your Substrate node with the off-chain indexing flag *ON*.
...
2. Define the indexing data and save it using off-chain indexing:
...
3. Use the `offchain_worker` hook method to read the data in the off-chain workers' database:
