...
[`Randomness`](/rustdocs/latest/frame_support/traits/trait.Randomness.html) that codifies
...
[Randomness Collective Flip Pallet](/rustdocs/latest/pallet_randomness_collective_flip/index.html).
...
The second implementation is the [BABE pallet](/rustdocs/latest/pallet_babe/index.html),
...
- [Different applications for randomness](https://en.wikipedia.org/wiki/Applications_of_randomness)
...
- View the Rustdocs on the
  [`Randomness` Trait](/rustdocs/latest/frame_support/traits/trait.Randomness.html)
