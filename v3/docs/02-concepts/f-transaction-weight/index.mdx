...
[Transaction Fees document](/v3/runtime/weights-and-fees).

Substrate defines one unit of weight as one picosecond of execution time, that is **10<sup>12</sup>
...
Benchmarking on reference hardware makes
...
[numeric value](/rustdocs/latest/frame_support/weights/type.Weight.html).
...
The [System pallet](/rustdocs/latest/frame_system/pallet/index.html) is
...
[Transaction Payment pallet](/rustdocs/latest/pallet_transaction_payment/index.html)
...
[`MaximumBlockLength`](/rustdocs/latest/frame_system/limits/struct.BlockLength.html)
and
[`MaximumBlockWeight`](/rustdocs/latest/frame_system/limits/struct.BlockWeights.html).
...
[Transaction Fees](/v3/runtime/weights-and-fees) to learn more about the different dispatch classes and
when to use them.
