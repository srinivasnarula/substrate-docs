...
- How to start a working Substrate-based blockchain node using the `substrate-node-template`.
...
- Ask questions on the dedicated [Stack Exchange](https://substrate.stackexchange.com).

- Submit an issue on [the docs source](https://github.com/substrate-developer-hub/substrate-docs/issues/new/choose)