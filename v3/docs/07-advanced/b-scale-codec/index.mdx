...
execution contexts, like the [Substrate runtime](/v3/concepts/runtime). It is not self-describing in any way
...
- PHP: [`gmajor-encrypt/php-scale-codec`](https://github.com/gmajor-encrypt/php-scale-codec)

## References

- Visit the reference docs for the
  [`parity-scale-codec`](/rustdocs/latest/parity_scale_codec/index.html).
